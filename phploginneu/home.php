	...
	<body class="loggedin">
		<nav class="navtop">
			<div>
				...
				<a href="ereigniszuweisenerstellen.html"><i class="fa fa-user-circle"></i>Arbeitszeiten</a>
				<a href="passwort.html"><i class="fa fa-thumbs-down"></i>Nicht-Verfügbarkeit</a>
				<a href="aufgaben.php"><i class="fa fa-tasks"></i>Aufgaben</a>
				<a href="arbeitnehmererstellen.html"><i class="fa fa-user-circle"></i>Meetings</a>
