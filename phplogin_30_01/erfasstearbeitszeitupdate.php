...
$statement = $pdo->prepare("UPDATE erfasstearbeitszeit SET beginn=$beginn, ende=$ende ,beschreibung=$beschreibung 
WHERE arbeitszeitid=$arbeitszeitid");
$statement->execute(array ( $beginn ,$ende ,$beschreibung, $arbeitszeitid));
...
?>
   ...
   <a href="erfasstearbeitszeitausgabe.html"><button>Erfasste Arbeitszeiten ansehen.</button></a>
