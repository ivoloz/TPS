...
$pdo = new PDO('mysql:host=localhost;dbname=tps', 'root', '');
    ...
    $abfrage = "SELECT beginn,ende, bezeichnung,beschreibung FROM meeting where meetingid=$meetingid";
...
<div class="content">
<div class="formular">
<label><h1>Bitte Felder ausfüllen um Meetings zu bearbeiten:</h1></label></br>
			<form action="meetingupdate.php" method="post" autocomplete="on">
	
<label for="meetingid"></label>
    <input type="hidden" value="<?php echo $meetingid; ?>" name="meetingid" /></br>	
...
<?php echo "<td><a href='meetinglöschen.php?meetingid=".$meetingid."'><button> löschen</button></a></td></br>"; ?>
