...
<html>
	...
	<body class="loggedin">
		...
		<div class="content">
			<p>Hinweis: Nur die zuletzt als abgerechnet markierte Monatsabrechnung wird dem zugehörigen Arbeitnehmer angezeigt.<br>
			Achten Sie auf die richtige Eingabe, andernfalls wenden Sie sich an den Systemadmin.</p>
...
include 'crud.php';
$sql = "SELECT * FROM `monatsabrechnung` ";
