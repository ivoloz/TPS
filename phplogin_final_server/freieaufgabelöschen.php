...
$statement = $pdo->prepare("DELETE FROM aufgabe WHERE  aufgabeid = ?  ");
$statement->execute(array($aufgabeid));
?>

	 </body>
       </html>
	   <br>
	   <p> Sie haben erfolgreich eine freie Aufgabe entfernt.</p>

<div class="content">
   <a href="aufgabeausgabe.php"><button>Weitere Aufgaben verwalten</button></a>
