...
$statement = $pdo->prepare("UPDATE meeting SET beginn=?, ende=? , bezeichnung=? , beschreibung=?
WHERE meetingid=?");
$statement->execute(array ($beginn ,$ende ,$bezeichnung, $beschreibung, $meetingid));
...
?>
	   ...
	   <br>
<div class="content">
<p>Sie haben erfolgreich ein Meeting bearbeitet.</p>

<div class="content">
   <a href="meetingausgabe.php"><button>Meetings ansehen.</button></a>
