...
if (!isset($_POST['vorname'],$_POST['nachname'], $_POST['email'], $_POST['passwort'], $_POST['kaz_von'], $_POST['kaz_bis'], $_POST['max_gesamtstunden'],$_POST['max_ueberstunden'])) {
	// Could not get the data that should have been sent.
	die ('Please complete the registration form!');
}
// Make sure the submitted registration values are not empty.
if (empty($_POST['vorname']) || empty($_POST['nachname']) || empty($_POST['email']) || empty($_POST['passwort'])|| empty($_POST['kaz_von'])|| empty($_POST['kaz_bis'])|| empty($_POST['max_gesamtstunden'])|| empty($_POST['max_ueberstunden'])) {
...
if ($stmt = $con->prepare('INSERT INTO benutzer (rollenid, vorname,nachname, email, passwort, kaz_von, kaz_bis, max_gesamtstunden, max_ueberstunden) VALUES ( ?,?, ?, ?,?,?,?,?,?)')) {
    ...
    $stmt->bind_param('sssssssss', $rollenid, $_POST['vorname'], $_POST['nachname'],$_POST['email'], $passwort ,$_POST['kaz_von'],$_POST['kaz_bis'],$_POST['max_gesamtstunden'],$_POST['max_ueberstunden']);
	$stmt->execute();
try {
            ...
            $message->setBody("Sehr geehrter Mitarbeiter, hier ihr vorläufiges Passwort: ".$_POST['passwort'].
