...
$monatsabrechnungid = $_SESSION["id"];
...
$statement = $pdo->prepare("DELETE FROM monatsabrechnung WHERE  monatsabrechnungid = ?  ");
$statement->execute(array($monatsabrechnungid));
?>

	 </body>
       </html>
	   <br>
	   <p> Sie haben erfolgreich eine Monatsabrechnung entfernt.</p>


   <a href="abrechnungausgabe.php"><button>Weitere Monatsabrechnungen verwalten.</button></a>
