...
if($_GET['monatsabrechnungid']) {
  $monatsabrechnungid = $_GET['monatsabrechnungid'];
}
...
$statement = $pdo->prepare("UPDATE monatsabrechnung SET abgerechnet=$abgerechnet WHERE monatsabrechnungid = $monatsabrechnungid");
$statement->execute(array ($abgerechnet ,$monatsabrechnungid));
...
<p> Sie haben erfolgreich eine Monatsabrechnung als erledigt ausgewählt!</p>
 <a href="abrechnungausgabe.php"><button>Monatsabrechnungen ansehen</button></a>
