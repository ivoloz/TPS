...
$statement = $pdo->prepare("DELETE FROM nichtverfugbarkeit WHERE  nichtverfugbarkeitid = ?  ");
...
?>
	   ...
	   <br>
	   <p> Sie haben erfolgreich eine Nicht-Verfügbarkeit entfernt.</p>

<div class="content">
   <a href="nichtverfugbarkeitausgabe.php"><button>Weitere Nicht-Verfügbarkeiten verwalten.</button></a>
