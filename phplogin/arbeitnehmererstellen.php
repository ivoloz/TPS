...
if ($stmt = $con->prepare('INSERT INTO benutzer (arbeitgeberid, rollenid, vorname,nachname, email, passwort, kaz_von, kaz_bis, max_gesamtstunden, max_ueberstunden) VALUES ( ?,?,?, ?, ?,?,?,?,?,?)')) {
    ...
    $stmt->bind_param('ssssssssss', $arbeitgeberid, $rollenid, $_POST['vorname'], $_POST['nachname'],$_POST['email'], $pwhashed, $_POST['kaz_von'],$_POST['kaz_bis'],$_POST['max_gesamtstunden'],$_POST['max_ueberstunden']);
	$stmt->execute();
try {
